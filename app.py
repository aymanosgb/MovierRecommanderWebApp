...
st.markdown("<h6 style='text-right: center; color: black;'>Web App created by Ayman Moumen        Supervised M. Cédric Stéphane KOUMETIO TEKOUABOU</h4>", unsafe_allow_html=True)
st.markdown("<h6 style='text-left: center; color: black;'>                    Marwane Limouri </h4>", unsafe_allow_html=True)
