...
st.markdown("<h6 style='text-right: center; color: black;'>Web App created by Ayman MoumenSupervised M. Cédric Stéphane KOUMETIO TEKOUABOU</h4>", unsafe_allow_html=True)
